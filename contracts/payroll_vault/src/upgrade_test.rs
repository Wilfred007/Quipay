...
pub mod v2_contract {
    ...
    impl PayrollVaultV2 {
        pub fn initialize(e: Env, admin: Address) -> Result<(), QuipayError> {
            ...
            e.storage()
                .persistent()
                .set(&StateKey::TransactionCount, &0u64);
            Ok(())
        }
        ...
        pub fn upgrade(
            ...
            let current_version: VersionInfo = e
                .storage()
                .persistent()
        ...
        pub fn deposit(
            ...
            let tx_count: u64 = e
                .storage()
                .persistent()
                .get(&StateKey::TransactionCount)
                .unwrap_or(0);
            e.storage()
                .persistent()
                .set(&StateKey::TransactionCount, &(tx_count + 1));
        ...
        pub fn payout(
            ...
            e.storage()
                .persistent()
                .set(&balance_key, &(treasury - amount));
            let tx_count: u64 = e
                .storage()
                .persistent()
                .get(&StateKey::TransactionCount)
